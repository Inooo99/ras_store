...
<body class="bg-gray-50 flex items-center justify-center min-h-screen py-10">
    ...
    <div class="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden p-8">
        <div class="text-center mb-8">
            <h1 class="text-2xl font-bold text-yellow-600 serif mb-2">Ras Store</h1>
            <p class="text-gray-500">Buat akun baru untuk mulai belanja.</p>
        </div>
        ...
        <div class="mt-6 text-center text-sm text-gray-500">
            Sudah punya akun? 
            {{-- Gunakan url() juga disini biar aman --}}
            <a href="{{ url('/login') }}" class="text-yellow-600 font-bold hover:underline">Masuk di sini</a>
        </div>
        
        <div class="mt-4 text-center text-sm text-gray-500">
            <a href="{{ url('/') }}" class="hover:text-yellow-600 transition-colors">&larr; Kembali ke Beranda</a>
        </div>
    </div>
